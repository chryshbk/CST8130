...
public class OurDate {
	...
	public boolean isGreater(OurDate rhs) {
		if (rhs.getYear() >= getYear() && rhs.getMonth() >= getMonth() && rhs.getDay() > getDay())
			return true;
		if (rhs.getYear() >= getYear() && rhs.getMonth() > getMonth())
			return true;
		if (rhs.getYear() > getYear())
			return true;
		return false;	
	}
	@Override
	...
	public boolean readDate(Scanner in, char prompt) {
		...
		} while (this.month <= 0 || this.month > 12 || (this.month == 2 && this.day > 29) || (this.day > 30 && (this.month == 9 ||this.month == 4 ||this.month == 6 ||this.month == 11)));
